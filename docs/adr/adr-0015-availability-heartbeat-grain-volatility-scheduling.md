...
- ~~**Open follow-up:** the WD/Seagate XHR-endpoint recon spike~~ — **done 2026-07-04**: both sources confirmed fast-lane eligible (WD via unauthenticated OCC JSON; Seagate via robots-allowed category-page bootstrap JSON — its store GraphQL is robots-disallowed). See the [endpoint-recon spike report](../research/2026-07-04-wd-seagate-recert-endpoint-recon.md).
