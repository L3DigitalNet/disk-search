...
Yes — more so than the alternatives, not despite them. Re-reading the spec's [General Design Principles](../specs/hw-radar.md#general-design-principles) against the architecture:
