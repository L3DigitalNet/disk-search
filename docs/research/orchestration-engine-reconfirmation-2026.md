...
Yes — more so than the alternatives, not despite them. Re-reading the spec's [General Design Principles](../specs/hw-radar-master-spec.md#1-purpose--background) against the architecture:
